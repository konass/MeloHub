...
import com.example.socialapp.presentation.profile.ProfilePeopleViewModel
...
class ProfilePeopleAdapter (private val listener: ProfilePeopleItemClickListener, val profileViewModel: ProfilePeopleViewModel):  RecyclerView.Adapter<ProfilePeopleAdapter.PostViewHolder>(){
...
//            holder.binding.imLike.setOnClickListener {
...
interface ProfilePeopleItemClickListener {
