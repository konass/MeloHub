...
//                    viewHolder.view.txtTime.visibility = View.GONE
                ...
                if ((baseMessage.metadata != null && baseMessage.metadata.has("reply-message")) || (baseMessage.metadata != null && baseMessage.metadata.has("replyToMessage"))) {
                    try {
                        ...
                        viewHolder.view.replyAvatarLayout.visibility=View.VISIBLE
                       // viewHolder.view.replyItem.replyLayout.visibility = View.VISIBLE
                        viewHolder.view.tvUser.text= Utils.getSenderName(data)
                        when (messageType) {
                            CometChatConstants.MESSAGE_TYPE_TEXT -> {
                                viewHolder.view.textMessage?.text= replyMessage
                                //viewHolder.view.replyMediaThumbnail.visibility = View.GONE
                            }
                            CometChatConstants.MESSAGE_TYPE_IMAGE -> {
                                viewHolder.view.textMessage?.text= context.resources.getString(R.string.message_image)
                               // viewHolder.view.replyItem.replyMediaThumbnail.visibility = View.GONE
                            }
                            CometChatConstants.MESSAGE_TYPE_AUDIO -> {
                                viewHolder.view.textMessage?.text = context.resources.getString(R.string.message_audio)
                               // viewHolder.view.replyItem.replyMediaThumbnail.visibility = View.GONE
                            }
                            CometChatConstants.MESSAGE_TYPE_VIDEO -> {
                                viewHolder.view.textMessage?.text= context.resources.getString(R.string.message_video)
                               // viewHolder.view.replyItem.replyMediaThumbnail.visibility = View.GONE
                            }
                            CometChatConstants.MESSAGE_TYPE_FILE -> {
                                viewHolder.view.textMessage?.text = context.resources.getString(R.string.message_file)
                                //viewHolder.view.replyItem.replyMediaThumbnail.visibility = View.GONE
                            }
                            UIKitConstants.IntentStrings.LOCATION -> {
                                viewHolder.view.textMessage?.text = context.resources.getString(R.string.custom_message_location)
                               // viewHolder.view.replyItem.replyMediaThumbnail.visibility = View.VISIBLE
                            }
                            UIKitConstants.IntentStrings.STICKERS -> {
                                viewHolder.view.textMessage?.text = context.getString(R.string.custom_message_sticker)
                              //  viewHolder.view.replyItem.replyMediaThumbnail.visibility = View.GONE
                            }
                            UIKitConstants.IntentStrings.WHITEBOARD -> {
                                viewHolder.view.textMessage?.text= context.getString(R.string.custom_message_whiteboard)
                                    //  viewHolder.view.replyItem.replyMediaThumbnail.visibility = View.GONE
                            }
                            UIKitConstants.IntentStrings.WRITEBOARD -> {
                                viewHolder.view.textMessage?.text= context.getString(R.string.custom_message_document);
                            //    viewHolder.view.replyItem.replyMediaThumbnail.visibility = View.GONE
                            }
                            UIKitConstants.IntentStrings.POLLS -> {
                                viewHolder.view.textMessage?.text = context.getString(R.string.custom_message_poll)
                              //  viewHolder.view.replyItem.replyMediaThumbnail.visibility = View.GONE
                            }
                            UIKitConstants.IntentStrings.MEETING -> {
                                viewHolder.view.textMessage?.text= context.getString(R.string.custom_message_meeting)
                               // viewHolder.view.replyItem.replyMediaThumbnail.visibility = View.GONE
                            }
                        }
                    } catch (e: java.lang.Exception) {
